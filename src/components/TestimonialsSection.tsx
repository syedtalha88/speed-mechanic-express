...
const testimonials = [
  { name: "Rahul Sharma", area: "Madhapur", bike: "RE Classic 350", text: "XpMechanics serviced my Classic 350 at my office parking. The mechanic was super professional, and my bike runs like new. Highly recommended!", rating: 5 },
  { name: "Priya Reddy", area: "Gachibowli", bike: "Honda Activa", text: "I was tired of workshop queues. XpMechanics picked up my Activa, serviced it, and dropped it back the same day. The free pickup saved me so much time!", rating: 5 },
  { name: "Vikram Patel", area: "Kukatpally", bike: "Bajaj Pulsar", text: "Transparent pricing, genuine parts, and a mechanic who actually explained what was wrong. This is how bike service should be.", rating: 5 },
  { name: "Ananya Devi", area: "Jubilee Hills", bike: "TVS Jupiter", text: "Booked on XpMechanics, the mechanic arrived on time and did a thorough job. No more wasting weekends at workshops. Incredible convenience!", rating: 5 },
  ...
  { name: "Deepak Rao", area: "Secunderabad", bike: "RE Himalayan", text: "My Himalayan needed brake pads and chain replacement. XpMechanics handled it at my home. Their free pickup and drop saved me half a day!", rating: 5 },
];
      ...
      <ScrollReveal variant="mechanical-slide">
        <div className="text-center mb-10 md:mb-14">
          <span className="inline-flex items-center gap-2 text-xs md:text-sm font-bold uppercase tracking-widest text-primary mb-3">
            <Star className="h-4 w-4" /> XpMechanics Reviews
          </span>
          ...
          <p className="text-sm md:text-base text-muted-foreground mt-3 max-w-xl mx-auto">
            Real reviews from real riders who chose XpMechanics for their bike service needs.
          </p>
        </div>
      </ScrollReveal>
