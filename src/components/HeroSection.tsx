      ...
      <div className="text-background">
        ...
        <ScrollReveal variant="fade-up" delay={700}>
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <button className="group relative mechanical-btn bg-primary text-primary-foreground font-heading font-bold uppercase text-sm md:text-base px-8 md:px-10 py-3.5 md:py-4 hover:bg-accent transition-all duration-300 shadow-xl overflow-hidden">
            ...
            <button className="mechanical-btn border-2 border-background/30 text-background font-heading font-bold uppercase text-sm md:text-base px-8 md:px-10 py-3.5 md:py-4 hover:bg-background/10 transition-all duration-300 group">
        ...
        <div className="glass-card p-6 md:p-8 max-w-md mx-auto lg:ml-auto w-full relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <form className="space-y-3 md:space-y-4" onSubmit={(e) => e.preventDefault()}>
              <input type="text" placeholder="Your Name" className="w-full px-5 py-3 md:py-3.5 bg-background/80 border border-border text-foreground font-body text-sm focus:outline-none focus:border-primary focus:bg-background transition-all duration-300 mechanical-input" />
              <input type="tel" placeholder="Phone Number" className="w-full px-5 py-3 md:py-3.5 bg-background/80 border border-border text-foreground font-body text-sm focus:outline-none focus:border-primary focus:bg-background transition-all duration-300 mechanical-input" />
              <select className="w-full px-5 py-3 md:py-3.5 bg-background/80 border border-border text-foreground font-body text-sm focus:outline-none focus:border-primary focus:bg-background transition-all duration-300 mechanical-input appearance-none">
              ...
              <input type="text" placeholder="Your Location / Area in Hyderabad" className="w-full px-5 py-3 md:py-3.5 bg-background/80 border border-border text-foreground font-body text-sm focus:outline-none focus:border-primary focus:bg-background transition-all duration-300 mechanical-input" />
              <button type="submit" className="group w-full mechanical-btn bg-primary text-primary-foreground font-heading font-bold uppercase text-sm md:text-base py-3.5 md:py-4 hover:bg-accent transition-all duration-300 shadow-lg relative overflow-hidden">
                <span className="relative z-10 flex items-center justify-center gap-2">
                  Get Free Quote
